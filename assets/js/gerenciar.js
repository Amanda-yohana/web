...
const adicionarNaTabela = (dados) => {
    ...
    dados.forEach(produto => {
        //calcula número de linhas atual da tabela 
        const tamanhoTabela = tabela.rows.lenght
        // insere uma linha abaixo da ultima
        const linha = tabela.insertRow(tamanhoTabela)
        //insere as celualas da linha
...
// função para excluir uma linha da tabela de do banco de dados pelo id
